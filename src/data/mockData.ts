...
export const translations = {
  en: {
    ...
    seedBank: 'Seed Bank',
    mapcn: 'Market',
    mapcnTitle: 'Market - Mandi & APMC Price Commodity Network',
  ...
  ta: {
    ...
    voiceAI: 'குரல் உதவி',
    mapcn: 'சந்தை',
    mapcnTitle: 'சந்தை - APMC மண்டி விலை நெட்வொர்க்',
    mapcnSub: 'நேரடி சந்தை வரத்துகள், மாதிரி விலைகள் மற்றும் வர்த்தக நெட்வொர்க்',
    seedBank: 'வரைபடங்கள்',
  ...
  hi: {
    ...
    mapcn: 'मार्केट',
    mapcnTitle: 'मार्केट - मंडी एवं APMC कमोडिटी नेटवर्क',
    mapcnSub: 'लाइव मंडी आवक, मॉडल मूल्य, APMC केंद्र और ट्रेडिंग नेटवर्क',
  ...
  te: {
    ...
    voiceAI: 'వాయిస్ AI',
    mapcn: 'మార్కెట్',
    mapcnTitle: 'మార్కెట్ - మార్కెట్ & APMC ధరల నెట్‌వర్క్',
    mapcnSub: 'ప్రత్యక్ష మార్కెట్ రాకలు, మోడల్ ధరలు మరియు వ్యాపార నెట్‌వర్క్',
    seedBank: 'మ్యాప్‌లు',
